...
class OrderConfirmedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Order Confirm",style: TextStyle(color: ColorConstant.colorIntroBG)),
        backgroundColor: ColorConstant.colorWhite,
          ...
          child: Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // ✅ Check Icon
                  Icon(Icons.check_circle, color: ColorConstant.colorIntroBG, size: 80),
                  ...
                  OutlinedButton(
                    ...
                    child: Text("Go to Home",
                        style: TextStyle(color: ColorConstant.colorIntroBG, fontSize: 16)),
                  ),
                ],
              ),
            ),
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 14,
            fontWeight: FontWeight.bold,
            color: highlight ? ColorConstant.colorIntroBG : Colors.black87,
          ),
        ),
      ],
    );
