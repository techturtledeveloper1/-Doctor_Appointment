  ...
  AppBar getAppBar() {
    switch (tabIndex) {
      ...
      case 3:
        ...
        return AppBar(
          backgroundColor: ColorConstant.colorWhite,
          title: Text("Prescriptions",style: TextStyle(color: ColorConstant.colorIntroBG)),
          centerTitle: true,
          leading: IconButton(
            icon: Icon(Icons.menu_rounded, size: 29.0, color: ColorConstant.colorIntroBG),
            onPressed: () => _advancedDrawerController.showDrawer(),
          ...
          children: [
            ...
            ExpansionTile(
              ...
              children: [
                ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                          const ConsultPsychiatristScreen()),
                    );
                  },
                ),
                ListTile(
                ...
                ListTile(
                  leading:
                  Icon(Icons.healing, color: ColorConstant.colorIntroBG),
