  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.edit, color: ColorConstant.colorIntroBG),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: _inputDecoration("Gender").copyWith(
                hintText: _gender ?? "Not specified",
              ),
            ),
            const SizedBox(height: 15),
            ...
            TextFormField(
              ...
              decoration: _inputDecoration("Blood Group").copyWith(
                hintText: _bloodGroup ?? "Not specified",
              ),
            ),
            const SizedBox(height: 15),
            ...
            TextFormField(
              readOnly: true,
              decoration: _inputDecoration("Height").copyWith(
                hintText: _height ?? "Not specified",
              ),
            ),
            const SizedBox(height: 15),
            ...
            TextFormField(
              readOnly: true,
              decoration: _inputDecoration("Weight").copyWith(
                hintText: _weight ?? "Not specified",
              ),
            ),
            const SizedBox(height: 15),
            ...
            TextFormField(
              readOnly: true,
              decoration: _inputDecoration("Medical History").copyWith(
                hintText: _hasMedicalHistory ? "Yes" : "No",
              ),
            ),

            if (_hasMedicalHistory && _medicalIssueCtrl.text.isNotEmpty) ...[
              const SizedBox(height: 15),
              TextFormField(
