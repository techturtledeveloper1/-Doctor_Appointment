            ...
            children: [
                    ...
                    GestureDetector(
                      ...
                      child: CircleAvatar(
                        ...
                        child: _selectedImage == null && (_profileImageUrl == null || _profileImageUrl!.isEmpty)
                            ? Icon(Icons.person, size: 60, color: ColorConstant.colorIntroBG)
                            : null,
                      ),
                    ),
                    Positioned(
              ...
              TextFormField(
                ...
                decoration: _inputDecoration(
                  ...
                  suffix: Icon(Icons.calendar_today, color: ColorConstant.colorIntroBG),
                ),
              ),
              if (_age != null) ...[
                SizedBox(height: 10),
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                    ...
                    child: CircularProgressIndicator(
                      ...
                      : Text(
                    "Save Details",
                    style: TextStyle(fontSize: 16, color: ColorConstant.colorWhite),
                  ),
                ),
              ),
            ],
