...
import 'UpdateAddress_Screen.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          if (!isLoading)
            IconButton(
              icon: Icon(Icons.add, color: ColorConstant.colorIntroBG),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
  ...
  Widget _buildLoadingState() {
    return Center(
      child: CircularProgressIndicator(
        valueColor: AlwaysStoppedAnimation<Color>(ColorConstant.colorIntroBG),
      ),
    );
  }
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: ColorConstant.colorIntroBG),
                  ),
                  child: Text(
