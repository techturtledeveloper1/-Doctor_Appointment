...
import 'MyPrescriptions/MyPrescriptions_Screen.dart';
import 'PersonalDetailsScreen/PersonalDetails_Screen.dart';
          ...
          children: [
            ...
            CircleAvatar(
              ...
              child: imageUrl.isEmpty
                  ? Icon(Icons.person,
                  size: 50, color: ColorConstant.textColor2)
                  : null,
              backgroundColor: ColorConstant.colorWhite,
            ),
            SizedBox(height: 15),
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5),
                Icon(Icons.edit, size: 18, color: ColorConstant.colorIntroBG),
              ],
            ),
            SizedBox(height: 30),
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(color: ColorConstant.deviderColour2),
                      borderRadius: BorderRadius.circular(10),
                      color: ColorConstant.colorWhite,
                    ),
                    child: Row(
                      children: [
                        Icon(item['icon'], color: ColorConstant.colorIntroBG),
                        SizedBox(width: 15),
                        Expanded(
                          child: Text(
                            item['title'],
                        ...
                        Icon(Icons.arrow_forward_ios,
                            size: 18, color: ColorConstant.textColor2),
                      ],
                    ),
                  ),
                );
