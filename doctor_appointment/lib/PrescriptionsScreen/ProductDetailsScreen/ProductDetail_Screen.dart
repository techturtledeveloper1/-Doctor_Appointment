              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 6),
                    Text("Prescription required for this product",
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text("Add to Cart",style: TextStyle(color: ColorConstant.colorWhite),),
                  ),
                ),
                SizedBox(width: 12),
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text("Buy Now",style: TextStyle(color: ColorConstant.colorWhite),),
                  ),
                ),
              ],
            )
