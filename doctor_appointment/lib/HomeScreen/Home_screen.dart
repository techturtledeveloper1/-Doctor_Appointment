...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> services = [
    ...
    {"icon": Icons.science, "label": "Lab Tests", "color": ColorConstant.textColor2},
    {
    ...
    {"icon": Icons.add, "label": "Radiology", "color": ColorConstant.textColor2},
  ];
            ...
            children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(packages[index]["image"]!,
                                height: 120,
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("THS PRO PLAN",
                        style: TextStyle(
                            color: Colors.yellow,
                            fontWeight: FontWeight.bold,
                            fontSize: 18)),
                    const SizedBox(height: 6),
                    const Text("Avail special discounts",
