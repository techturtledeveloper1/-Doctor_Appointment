  ...
  Widget _buildLoadingState() {
    return Center(
      child: Column(
        ...
        children: [
          CircularProgressIndicator(color: ColorConstant.colorIntroBG),
          SizedBox(height: 16),
          Text(
              ...
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.refresh,
                      size: 26, color: ColorConstant.colorIntroBG),
                  onPressed: _loadAppointmentsFromAPI,
                ),
              ],
            ),
              ...
              child: Padding(
                ...
                child: TableCalendar(
                  ...
                  headerStyle: HeaderStyle(
                    ...
                    leftChevronIcon:
                    Icon(Icons.chevron_left, color: ColorConstant.colorIntroBG),
                    rightChevronIcon:
                    Icon(Icons.chevron_right, color: ColorConstant.colorIntroBG),
                  ),
                ),
              ),
            ),
            ...
            child: Row(
              children: [
                Icon(Icons.calendar_today,
                    color: ColorConstant.colorIntroBG, size: 20),
                SizedBox(width: 8),
                Text(
