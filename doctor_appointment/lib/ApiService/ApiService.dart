...
class ApiService {
  ...
  Future<Map<String, dynamic>> cancelAppointment(
    String appointmentId, {
    String reason = "Cancelled by patient",
    ...
    try {
      ...
      // ✅ FIX: Use query parameter for ID and body for reason
      // URL: /api/appointment/cancel?id=appointmentId
      String cancelUrl = "${baseurl}appointment/cancel?id=$appointmentId";
  ...
  // Your existing reschedule method (working)
